...
"""Test the custom osc controller from gym_flexassembly.controller without nullspace control (elbow falls down).
:Author:
...
frame_ghost_id = p.loadURDF("visualization/frame_ghost.urdf", useFixedBase=True)
...
#                    parentLinkIndex=-1)
frame_ghost_id_2 = p.loadURDF("visualization/frame_ghost.urdf", useFixedBase=True)
...
schunk = p.loadURDF("robots/schunk-egp-40/model.urdf", useFixedBase=False)
