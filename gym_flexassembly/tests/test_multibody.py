...
visualShapeId = p.createVisualShape(shapeType=p.GEOM_MESH,
                                    fileName="/home/dwigand/code/cogimon/CoSimA/pyBullet/catkin_py_ws/src/py-flex-assembly/gym_flexassembly/data/schunk-egp-40/meshes/visual/obj/schunk_low_baked_small.obj",
                                    rgbaColor=[1, 1, 1, 1],
